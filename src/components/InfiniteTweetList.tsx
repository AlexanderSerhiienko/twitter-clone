...
import InifiteScroll from "react-infinite-scroll-component";
...
export const InfiniteTweetList = ({
  ...
  if (!tweets || !tweets.length)
    return (
      <h2 className="text-gray my-4 text-center text-2xl text-gray-500">
        No tweets
      </h2>
    );
...
const HeartButton = ({
  ...
  return (
    <button
      disabled={isLoading}
      onClick={onClick}
      className={`group -ml-2 flex items-center gap-1 self-start transition-colors duration-200 hover:text-red-500 focus-visible:text-red-500 ${
